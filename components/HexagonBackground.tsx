...
export default function HexagonBackground({ children }: { children?: React.ReactNode }) {
  const { width, height } = useWindowDimensions();

  return (
    <View className="absolute left-0 top-0 flex-1 bg-primary/5">
      <Svg width={width} height={height}>
        <Defs>
          <Pattern id="hex-pattern" patternUnits="userSpaceOnUse" width={28} height={49}>
            <G fill="#180c13" fillOpacity={0.25}>
