...
export const THEME = {
  light: {
    ...
    foreground: 'hsl(240 17% 5%)',
    card: 'hsl(288 100% 95%)',
    cardForeground: 'hsl(240 17% 5%)',
    popover: 'hsl(0 0% 100%)',
    popoverForeground: 'hsl(240 17% 5%)',
    primary: 'hsl(288 100% 31%)',
    primaryForeground: 'hsl(240 17% 5%)',
    secondary: 'hsl(288 35% 75%)',
    secondaryForeground: 'hsl(240 17% 5%)',
    muted: 'hsl(265 8% 96%)',
    mutedForeground: 'hsl(264 6% 56%)',
    accent: 'hsl(335 30% 64%)',
    accentForeground: 'hsl(240 17% 5%)',
    destructive: 'hsl(20 68% 51%)',
    border: 'hsl(265 7% 63.7%)',
    input: 'hsl(265 7% 63.7%)',
    ring: 'hsl(261 14% 69%)',
